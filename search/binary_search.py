class BinarySearch:
    ...
    def position(self):
        ...
        while high_pointer >= low_pointer:
            ...
            # print("searching index:", self.mid_pointer)
            if self.container_to_search[mid_pointer] < self.key_to_search_for:
                low_pointer = mid_pointer + 1
            elif self.container_to_search[mid_pointer] > self.key_to_search_for:
